...
class NWCI_Widget_Layered_Nav extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_id          = 'topnav_woocommerce_layered_nav';
		$this->widget_name        = __( '(TOPNAV) Filter Products by Attribute', 'woocommerce' );
		parent::__construct();
	}
...
register_widget( 'NWCI_Widget_Layered_Nav' );
